...
window.SKIN_MANIFEST = {
  ...
  "skins": [
    ...
    },
    {
      ...
      "author": "stushansusu",
      "tagline": "暗色专用 · 冰殿 · 深蓝外袍 · 银灰描框 · 霜棱画框",
      "description": "按桌面宠物「冰晶公主」的设定色走：主深蓝 #1A4B94 是外袍与蝴蝶结，中宝蓝 #3277D8 是衣饰与宝石，浅天蓝 #63B8F0 是发梢高光与裙摆渐变，亮白 #FFFFFF 是衣身与长袜，银灰 #D6E4F5 走腰带与镶边，瞳色 #589CE6 是那双眼睛。界面就照着这身衣服分：白铺面（衣身）、深蓝压底（外袍）、银灰走所有发丝级的分割线、宝蓝与天蓝只做宝石与高光，不铺面。整套唯一的暖色是肤色 #F9DDD0——只留在首屏霜环的正中心，冰里还亮着一点体温。",
      "accent": "#3277D8",
      "preview": {
    ...
    },
    {
      ...
      "description": "山顶天文台的观测室：黄铜仪器、午夜靛的天。不是「工程蓝图」那套制图——那是青线网格；这套是圆、弧、刻度、铆钉，全是线，没有一处面积填充。中性层是午夜靛，只带色温不带彩度；老黄铜是全场唯一有彩度的东西，只走线、走字、走点睛。母题是观测室本身：穹顶的纬度环与扇形肋缝、底部的十二时辰刻度带、一排黄铜铆钉，加上星等标尺与水准泡。红只留给需要你看一眼的信号灯。",
      "accent": "#c2a55a",
      "preview": {
    ...
    },
    {
      ...
      "description": "同一个海岸的两段时间。明亮是白昼的沙滩椰林：暖沙地、湿沙的水痕、断断续续的浪线、近岸泛青的海，椰子树用二十格高的点阵剪影立在沙上，天上挂着一颗阶梯太阳；暗色是深夜的星空银河：夜空蓝黑、二百三十颗点阵星加一条由淡点堆出来的银河拱，海平线往上是月亮照亮的银灰滩涂，水里压着几道星光倒影。两套都不靠渐变——明暗是 8px 一格的棋盘抖动堆出来的，像素画里没有平滑 ramp。所有圆角归零（像素画只有直角和 45 度），每张卡片一圈 2px 精灵描边加 4px 实心投影。海岸线锚在底边上（沙 286px、海 134px），从一千像素到七百像素高，椰子树都站在沙里。",
      "accent": "#0F7182",
      "preview": {
    ...
    },
    {
      ...
      "nameEn": "Gold & Mineral",
      "author": "stushansusu",
      "tagline": "赭石泥金 · 土红平涂 · 重彩描金 · 靛蓝夜色",
      "description": "重彩的一路，上美影的单线平涂：一笔墨线勾轮廓，里面填平色，面上不铺渐变，只有主按钮留一道金属斜光。浅色坐在绢本赭石上，土红作可点的主色、泥金作提醒；夜色换成靛蓝压底，泥金在深底上才真的像金。首屏只覆写一层径向光。用户自己说的话套一圈朱砂（朱批）。硬投影比常规厚一格（3px），因为金碧的线本来就重，投影薄了会被线吃掉。",
      "accent": "#A8462A",
      "preview": {
        "light": "assets/skins/shangmei-jinbi/preview/light.jpg",
        "dark": "assets/skins/shangmei-jinbi/preview/dark.jpg"
      },
      "contributes": {
        "stylesheet": "skin.css",
        "patches": "patches.css",
        "backgroundMedia": {
          "light": {
            "type": "image",
            "src": "assets/skins/shangmei-jinbi/assets/sym-light.webp",
            "scrim": "linear-gradient(104deg, rgba(253,243,224,0.48) 0%, rgba(253,243,224,0.28) 28%, rgba(253,243,224,0.08) 60%, rgba(253,243,224,0) 100%), linear-gradient(0deg, rgba(253,243,224,0.26) 0%, rgba(253,243,224,0) 32%)"
          },
          "dark": {
            "type": "image",
            "src": "assets/skins/shangmei-jinbi/assets/sym-dark.webp",
            "scrim": "linear-gradient(104deg, rgba(7,16,42,0.52) 0%, rgba(7,16,42,0.3) 28%, rgba(7,16,42,0.09) 60%, rgba(7,16,42,0) 100%), linear-gradient(0deg, rgba(7,16,42,0.32) 0%, rgba(7,16,42,0) 32%)"
          }
        }
      }
    },
    {
      "id": "mid-autumn",
      "name": "桂影月华",
      "nameEn": "Osmanthus Moonlight",
      "author": "stushansusu",
      "tagline": "金桂浮光 · 靛夜悬月 · 玉兔衔枝 · 花灯千盏",
      "description": "中秋的一路：底图是用户给的那张月夜图（右半暖金、左半靛蓝），明暗两个主题都走它，所以整套皮肤没有浅色版。界面全部改成夜色玻璃给画让路，再补一圈中秋家具——侧栏右缘「靛在外金在内」双线；首屏左上压一团月华柔光；顶栏是一整幅插画（月上桂梢、云头、三盏孔明灯、回纹边）；输入卡只留一圈金桂键线；会话头部只留夜色玻璃与一道底缘金线；工作区分组行做成灯谜签。朱批不用朱砂：金桂在外、青玉在内。强调色是金桂 #E7B44E，辅色青玉 #6BC6B0。",
      "accent": "#E7B44E",
      "preview": {
        "light": "assets/skins/mid-autumn/preview/light.jpg",
        "dark": "assets/skins/mid-autumn/preview/dark.jpg"
      },
      "contributes": {
        "stylesheet": "skin.css",
        "patches": "patches.css",
